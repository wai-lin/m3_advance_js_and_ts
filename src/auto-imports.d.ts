...
declare global {
  ...
  const queryClient: typeof import('./utils/tanstackQuery').queryClient
  const queryRpc: typeof import('./utils/rpc').queryRpc
  ...
  const rpc: typeof import('./utils/rpc').rpc
  const rpcClient: typeof import('./utils/rpc').rpcClient
  ...
  const useMutation: typeof import('./utils/tanstackQuery').useMutation
  const useNavigate: typeof import('@solidjs/router').useNavigate
  const useParams: typeof import('@solidjs/router').useParams
  const useQuery: typeof import('./utils/tanstackQuery').useQuery
